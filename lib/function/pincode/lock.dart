...
import 'package:note_application/screen/widget/custom_lock_pincode_widget.dart';

AwesomeDialog lock({required BuildContext context, required int? index}) {
  String? newPassword;
    ...
    body: Column(
      ...
      children: [
        ...
        CustomTwoButtonWidget(
          ...
          color: AppColor.ok,
          onPressed: () {
            _okOnPressed(newPassword, context);
          },
        ),
      ],
    ),
...
void _okOnPressed(String? newPassword, BuildContext context) {
  if (newPassword == null) {
    Flushbar(
    ...
    BlocProvider.of<PasswordCubit>(context).dataPassword(newPassword);
